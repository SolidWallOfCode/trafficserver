...
#if defined(_MSC_VER)
  char *
  strerror_r(int err, char *s, size_t n)
  {
...
#define snprintf _snprintf
  ...
  Errata &
  vlogf(Errata &err, Errata::Id id, Errata::Code code, char const *format, va_list &rest)
  {
  ...
  Errata &
  logf(Errata &err, Errata::Id id, Errata::Code code, char const *format, ...)
  {
    va_list rest;
