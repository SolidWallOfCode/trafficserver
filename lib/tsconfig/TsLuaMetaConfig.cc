...
public:
  ...
  SchemaDescriptor() : super_type{OBJECT, "object", "schema", "Schema for configuration"},
                       _properties{
                         {value_type::DESCRIPTION_DESCRIPTOR.name, reinterpret_cast<MPtr>(&value_type::DESCRIPTION_DATA)},
...
const TsLuaConfigObjectDescriptor<TsLuaMetaConfig::SchemaValue> TsLuaMetaConfig::SchemaValue::PROPERTIES_DESCRIPTOR("properties"_sv, "the schema properties"_sv,
...
template <> TsLuaMetaConfig::SchemaDescriptor const& TsLuaMetaConfig::SchemaProperties::value_type::DESCRIPTOR { TsLuaMetaConfig::SCHEMA_DESCRIPTOR};
...
TsLuaMetaConfig::MetaSchemaValue::MetaSchemaValue()
  : P_SCHEMA_DATA(p_schema, P_SCHEMA_DESCRIPTOR)
{}
...
TsLuaMetaConfig::SchemaData::SchemaData(value_type &v, SchemaDescriptor const &d) : super_type(d), _value(((v.get() || (v.reset(new SchemaValue),true)), *v))
{
}
