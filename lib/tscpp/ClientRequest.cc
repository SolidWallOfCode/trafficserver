 ...
 * @private
 */
struct tscpp::ClientRequestState : noncopyable {
  TSHttpTxn txn_;
...
tscpp::ClientRequest::ClientRequest(void *ats_txn_handle, void *hdr_buf, void *hdr_loc) : Request(hdr_buf, hdr_loc)
{
  state_ = new ClientRequestState(static_cast<TSHttpTxn>(ats_txn_handle));
}

tscpp::ClientRequest::~ClientRequest()
{
...
const Url &
tscpp::ClientRequest::getPristineUrl() const
{
