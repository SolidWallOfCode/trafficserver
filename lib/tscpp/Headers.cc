...
#include <ts/ts.h>
#include "tscpp/Headers.h"
#include "logging_internal.h"
#include "tscpp/noncopyable.h"

using tscpp::Headers;
using tscpp::HeaderField;
using tscpp::HeaderFieldName;
using tscpp::header_field_iterator;
using tscpp::header_field_value_iterator;
...
std::ostream &
operator<<(std::ostream &os, tscpp::Headers &obj)
{
