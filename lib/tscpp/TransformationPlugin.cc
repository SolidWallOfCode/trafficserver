...
using tscpp::TransformationPlugin;

/**
 * @private
 */
struct tscpp::TransformationPluginState : noncopyable {
  TSVConn vconn_;
  ...
  TransformationPluginState(tscpp::Transaction &transaction, TransformationPlugin &transformation_plugin,
