...
RecMessageMarshal_Realloc(RecMessage *msg, const RecRecord *record)
{
  ...
  char *msg_raw; // @a msg as a char pointer.
  ...
  msg_raw = reinterpret_cast<char *>(msg);
  ele_hdr = reinterpret_cast<RecMessageEleHdr *>(msg_raw + msg->o_write);
