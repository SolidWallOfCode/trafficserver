...
TSReturnCode
TSRemapNewInstance(int argc tscpp_UNUSED, char *argv[] tscpp_UNUSED, void **instance_handle, char *errbuf tscpp_UNUSED,
                   int errbuf_size tscpp_UNUSED)
{
