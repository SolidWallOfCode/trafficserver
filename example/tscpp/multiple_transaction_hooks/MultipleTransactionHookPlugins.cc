...
class MultipleTransactionHookPluginsOne : public tscpp::TransactionPlugin
{
public:
...
class MultipleTransactionHookPluginsTwo : public tscpp::TransactionPlugin
{
public:
...
class GlobalHookPlugin : public tscpp::GlobalPlugin
{
public:
