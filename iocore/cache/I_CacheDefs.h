...
enum CacheEventType {
  ...
  CACHE_EVENT_WRITER_UPDATED_ALT_TABLE = CACHE_EVENT_EVENTS_START + 30,
  CACHE_EVENT_TRY_LOCKED_OPERATION,
  CACHE_EVENT_STRIPE_LOCK_READY,
  CACHE_EVENT_ODE_LOCK_READY,
