...
ts::bwf::GlobalNames ts::bwf::Global_Names;
...
inline unsigned
radix10(ts::TextView src, ts::TextView &out)
{
  unsigned zret = 0;
...
#pragma GCC diagnostic ignored "-Wchar-subscripts"
  ...
  bool
  Format::FormatExtractor::operator()(std::string_view &literal_v, ts::bwf::Spec &spec)
  {
    literal_v = {};
