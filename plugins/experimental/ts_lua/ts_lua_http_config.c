...
typedef enum {
  ...
  TS_LUA_CONFIG_HTTP_CHUNKING_ACCEPT_TRUNCATED_CONTENT        = TS_CONFIG_HTTP_CHUNKING_ACCEPT_TRUNCATED_CONTENT,
...
ts_lua_var_item ts_lua_http_config_vars[] = {
  ...
  TS_LUA_MAKE_VAR_ITEM(TS_CONFIG_HTTP_CHUNKING_ACCEPT_TRUNCATED_CONTENT),
