...
TSContSchedule(TSCont contp, TSHRTime timeout, TSThreadPool tp)
{
  ...
  return TSContScheduleOnPool(contp, timeout, tp);
}
...
{
  // Gutting this function which is unused and gone in build 8.x
  // Removed the redirect_url data structure it used
  return TS_ERROR;
}
...
TSHttpTxnOutgoingAddrSet(TSHttpTxn txnp, const struct sockaddr *addr)
{
  ...
  sm->t_state.api_outbound_addr_set = true;
  return TS_SUCCESS;
}
...
using OV_Pair = std::tuple<const TSOverridableConfigKey, const TSRecordDataType>;
static const std::unordered_map<ts::string_view, OV_Pair> Overridable_Map(
  {{"proxy.config.srv_enabled", OV_Pair{TS_CONFIG_SRV_ENABLED, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.http", OV_Pair{TS_CONFIG_HTTP_CACHE_HTTP, TS_RECORDDATATYPE_INT}},
   {"proxy.config.ssl.hsts_max_age", OV_Pair{TS_CONFIG_SSL_HSTS_MAX_AGE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.normalize_ae", OV_Pair{TS_CONFIG_HTTP_NORMALIZE_AE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.chunking.size", OV_Pair{TS_CONFIG_HTTP_CHUNKING_SIZE, TS_RECORDDATATYPE_INT}},
   ...
   {"proxy.config.http.cache.range.write", OV_Pair{TS_CONFIG_HTTP_CACHE_RANGE_WRITE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.allow_multi_range", OV_Pair{TS_CONFIG_HTTP_ALLOW_MULTI_RANGE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.range.lookup", OV_Pair{TS_CONFIG_HTTP_CACHE_RANGE_LOOKUP, TS_RECORDDATATYPE_INT}},
   {"proxy.config.net.sock_packet_tos_out", OV_Pair{TS_CONFIG_NET_SOCK_PACKET_TOS_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.slow.log.threshold", OV_Pair{TS_CONFIG_HTTP_SLOW_LOG_THRESHOLD, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.max_stale_age", OV_Pair{TS_CONFIG_HTTP_CACHE_MAX_STALE_AGE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.default_buffer_size", OV_Pair{TS_CONFIG_HTTP_DEFAULT_BUFFER_SIZE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.response_server_str", OV_Pair{TS_CONFIG_HTTP_RESPONSE_SERVER_STR, TS_RECORDDATATYPE_STRING}},
   {"proxy.config.http.keep_alive_post_out", OV_Pair{TS_CONFIG_HTTP_KEEP_ALIVE_POST_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.net.sock_option_flag_out", OV_Pair{TS_CONFIG_NET_SOCK_OPTION_FLAG_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.net.sock_packet_mark_out", OV_Pair{TS_CONFIG_NET_SOCK_PACKET_MARK_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.websocket.active_timeout", OV_Pair{TS_CONFIG_WEBSOCKET_ACTIVE_TIMEOUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.server_tcp_init_cwnd", OV_Pair{TS_CONFIG_HTTP_SERVER_TCP_INIT_CWND, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.flow_control.enabled", OV_Pair{TS_CONFIG_HTTP_FLOW_CONTROL_ENABLED, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.send_http11_requests", OV_Pair{TS_CONFIG_HTTP_SEND_HTTP11_REQUESTS, TS_RECORDDATATYPE_INT}},
   {"proxy.config.body_factory.template_base", OV_Pair{TS_CONFIG_BODY_FACTORY_TEMPLATE_BASE, TS_RECORDDATATYPE_STRING}},
   {"proxy.config.http.anonymize_remove_from", OV_Pair{TS_CONFIG_HTTP_ANONYMIZE_REMOVE_FROM, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.keep_alive_enabled_in", OV_Pair{TS_CONFIG_HTTP_KEEP_ALIVE_ENABLED_IN, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.doc_in_cache_skip_dns", OV_Pair{TS_CONFIG_HTTP_DOC_IN_CACHE_SKIP_DNS, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.forward_connect_method", OV_Pair{TS_CONFIG_HTTP_FORWARD_CONNECT_METHOD, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.down_server.cache_time", OV_Pair{TS_CONFIG_HTTP_DOWN_SERVER_CACHE_TIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.insert_age_in_response", OV_Pair{TS_CONFIG_HTTP_INSERT_AGE_IN_RESPONSE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.url_remap.pristine_host_hdr", OV_Pair{TS_CONFIG_URL_REMAP_PRISTINE_HOST_HDR, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.insert_request_via_str", OV_Pair{TS_CONFIG_HTTP_INSERT_REQUEST_VIA_STR, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.flow_control.low_water", OV_Pair{TS_CONFIG_HTTP_FLOW_CONTROL_LOW_WATER_MARK, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.required_headers", OV_Pair{TS_CONFIG_HTTP_CACHE_REQUIRED_HEADERS, TS_RECORDDATATYPE_INT}},
   {"proxy.config.ssl.hsts_include_subdomains", OV_Pair{TS_CONFIG_SSL_HSTS_INCLUDE_SUBDOMAINS, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.number_of_redirections", OV_Pair{TS_CONFIG_HTTP_NUMBER_OF_REDIRECTIONS, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.keep_alive_enabled_out", OV_Pair{TS_CONFIG_HTTP_KEEP_ALIVE_ENABLED_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.response_server_enabled", OV_Pair{TS_CONFIG_HTTP_RESPONSE_SERVER_ENABLED, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.anonymize_remove_cookie", OV_Pair{TS_CONFIG_HTTP_ANONYMIZE_REMOVE_COOKIE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.request_header_max_size", OV_Pair{TS_CONFIG_HTTP_REQUEST_HEADER_MAX_SIZE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.parent_proxy.retry_time", OV_Pair{TS_CONFIG_HTTP_PARENT_PROXY_RETRY_TIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.insert_response_via_str", OV_Pair{TS_CONFIG_HTTP_INSERT_RESPONSE_VIA_STR, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.flow_control.high_water", OV_Pair{TS_CONFIG_HTTP_FLOW_CONTROL_HIGH_WATER_MARK, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.negative_caching_enabled", OV_Pair{TS_CONFIG_HTTP_NEGATIVE_CACHING_ENABLED, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.when_to_revalidate", OV_Pair{TS_CONFIG_HTTP_CACHE_WHEN_TO_REVALIDATE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.response_header_max_size", OV_Pair{TS_CONFIG_HTTP_RESPONSE_HEADER_MAX_SIZE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.anonymize_remove_referer", OV_Pair{TS_CONFIG_HTTP_ANONYMIZE_REMOVE_REFERER, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.global_user_agent_header", OV_Pair{TS_CONFIG_HTTP_GLOBAL_USER_AGENT_HEADER, TS_RECORDDATATYPE_STRING}},
   {"proxy.config.net.sock_recv_buffer_size_out", OV_Pair{TS_CONFIG_NET_SOCK_RECV_BUFFER_SIZE_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.net.sock_send_buffer_size_out", OV_Pair{TS_CONFIG_NET_SOCK_SEND_BUFFER_SIZE_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.connect_attempts_timeout", OV_Pair{TS_CONFIG_HTTP_CONNECT_ATTEMPTS_TIMEOUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.websocket.no_activity_timeout", OV_Pair{TS_CONFIG_WEBSOCKET_NO_ACTIVITY_TIMEOUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.negative_caching_lifetime", OV_Pair{TS_CONFIG_HTTP_NEGATIVE_CACHING_LIFETIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.default_buffer_water_mark", OV_Pair{TS_CONFIG_HTTP_DEFAULT_BUFFER_WATER_MARK, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.heuristic_lm_factor", OV_Pair{TS_CONFIG_HTTP_CACHE_HEURISTIC_LM_FACTOR, TS_RECORDDATATYPE_FLOAT}},
   {OutboundConnTrack::CONFIG_VAR_MAX, OV_Pair{TS_CONFIG_HTTP_PER_SERVER_CONNECTION_MAX, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.anonymize_remove_client_ip", OV_Pair{TS_CONFIG_HTTP_ANONYMIZE_REMOVE_CLIENT_IP, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.open_read_retry_time", OV_Pair{TS_CONFIG_HTTP_CACHE_OPEN_READ_RETRY_TIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.down_server.abort_threshold", OV_Pair{TS_CONFIG_HTTP_DOWN_SERVER_ABORT_THRESHOLD, TS_RECORDDATATYPE_INT}},
   {OutboundConnTrack::CONFIG_VAR_MATCH, OV_Pair{TS_CONFIG_HTTP_PER_SERVER_CONNECTION_MATCH, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.parent_proxy.fail_threshold", OV_Pair{TS_CONFIG_HTTP_PARENT_PROXY_FAIL_THRESHOLD, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.ignore_authentication", OV_Pair{TS_CONFIG_HTTP_CACHE_IGNORE_AUTHENTICATION, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.anonymize_remove_user_agent", OV_Pair{TS_CONFIG_HTTP_ANONYMIZE_REMOVE_USER_AGENT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.connect_attempts_rr_retries", OV_Pair{TS_CONFIG_HTTP_CONNECT_ATTEMPTS_RR_RETRIES, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.max_open_read_retries", OV_Pair{TS_CONFIG_HTTP_CACHE_MAX_OPEN_READ_RETRIES, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.auth_server_session_private", OV_Pair{TS_CONFIG_HTTP_AUTH_SERVER_SESSION_PRIVATE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.redirect_use_orig_cache_key", OV_Pair{TS_CONFIG_HTTP_REDIRECT_USE_ORIG_CACHE_KEY, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.ignore_client_no_cache", OV_Pair{TS_CONFIG_HTTP_CACHE_IGNORE_CLIENT_NO_CACHE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.ims_on_client_no_cache", OV_Pair{TS_CONFIG_HTTP_CACHE_IMS_ON_CLIENT_NO_CACHE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.heuristic_min_lifetime", OV_Pair{TS_CONFIG_HTTP_CACHE_HEURISTIC_MIN_LIFETIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.heuristic_max_lifetime", OV_Pair{TS_CONFIG_HTTP_CACHE_HEURISTIC_MAX_LIFETIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.server_session_sharing.match", OV_Pair{TS_CONFIG_HTTP_SERVER_SESSION_SHARING_MATCH, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.open_write_fail_action", OV_Pair{TS_CONFIG_HTTP_CACHE_OPEN_WRITE_FAIL_ACTION, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.insert_squid_x_forwarded_for", OV_Pair{TS_CONFIG_HTTP_INSERT_SQUID_X_FORWARDED_FOR, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.connect_attempts_max_retries", OV_Pair{TS_CONFIG_HTTP_CONNECT_ATTEMPTS_MAX_RETRIES, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.max_open_write_retries", OV_Pair{TS_CONFIG_HTTP_CACHE_MAX_OPEN_WRITE_RETRIES, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.forward.proxy_auth_to_parent", OV_Pair{TS_CONFIG_HTTP_FORWARD_PROXY_AUTH_TO_PARENT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.parent_proxy.mark_down_hostdb", OV_Pair{TS_CONFIG_PARENT_FAILURES_UPDATE_HOSTDB, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.negative_revalidating_enabled", OV_Pair{TS_CONFIG_HTTP_NEGATIVE_REVALIDATING_ENABLED, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.guaranteed_min_lifetime", OV_Pair{TS_CONFIG_HTTP_CACHE_GUARANTEED_MIN_LIFETIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.guaranteed_max_lifetime", OV_Pair{TS_CONFIG_HTTP_CACHE_GUARANTEED_MAX_LIFETIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.transaction_active_timeout_in", OV_Pair{TS_CONFIG_HTTP_TRANSACTION_ACTIVE_TIMEOUT_IN, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.post_connect_attempts_timeout", OV_Pair{TS_CONFIG_HTTP_POST_CONNECT_ATTEMPTS_TIMEOUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.ignore_client_cc_max_age", OV_Pair{TS_CONFIG_HTTP_CACHE_IGNORE_CLIENT_CC_MAX_AGE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.negative_revalidating_lifetime", OV_Pair{TS_CONFIG_HTTP_NEGATIVE_REVALIDATING_LIFETIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.transaction_active_timeout_out", OV_Pair{TS_CONFIG_HTTP_TRANSACTION_ACTIVE_TIMEOUT_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.background_fill_active_timeout", OV_Pair{TS_CONFIG_HTTP_BACKGROUND_FILL_ACTIVE_TIMEOUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.attach_server_session_to_client", OV_Pair{TS_CONFIG_HTTP_ATTACH_SERVER_SESSION_TO_CLIENT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.cache_responses_to_cookies", OV_Pair{TS_CONFIG_HTTP_CACHE_CACHE_RESPONSES_TO_COOKIES, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.keep_alive_no_activity_timeout_in",
    OV_Pair{TS_CONFIG_HTTP_KEEP_ALIVE_NO_ACTIVITY_TIMEOUT_IN, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.post.check.content_length.enabled",
    OV_Pair{TS_CONFIG_HTTP_POST_CHECK_CONTENT_LENGTH_ENABLED, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.cache_urls_that_look_dynamic",
    OV_Pair{TS_CONFIG_HTTP_CACHE_CACHE_URLS_THAT_LOOK_DYNAMIC, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.transaction_no_activity_timeout_in",
    OV_Pair{TS_CONFIG_HTTP_TRANSACTION_NO_ACTIVITY_TIMEOUT_IN, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.keep_alive_no_activity_timeout_out",
    OV_Pair{TS_CONFIG_HTTP_KEEP_ALIVE_NO_ACTIVITY_TIMEOUT_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.uncacheable_requests_bypass_parent",
    OV_Pair{TS_CONFIG_HTTP_UNCACHEABLE_REQUESTS_BYPASS_PARENT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.transaction_no_activity_timeout_out",
    OV_Pair{TS_CONFIG_HTTP_TRANSACTION_NO_ACTIVITY_TIMEOUT_OUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.background_fill_completed_threshold",
    OV_Pair{TS_CONFIG_HTTP_BACKGROUND_FILL_COMPLETED_THRESHOLD, TS_RECORDDATATYPE_FLOAT}},
   {"proxy.config.http.parent_proxy.total_connect_attempts",
    OV_Pair{TS_CONFIG_HTTP_PARENT_PROXY_TOTAL_CONNECT_ATTEMPTS, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.parent_proxy.connect_attempts_timeout",
    OV_Pair{TS_CONFIG_HTTP_PARENT_CONNECT_ATTEMPT_TIMEOUT, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.connect_attempts_max_retries_dead_server",
    OV_Pair{TS_CONFIG_HTTP_CONNECT_ATTEMPTS_MAX_RETRIES_DEAD_SERVER, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.parent_proxy.per_parent_connect_attempts",
    OV_Pair{TS_CONFIG_HTTP_PER_PARENT_CONNECT_ATTEMPTS, TS_RECORDDATATYPE_INT}},
   {"proxy.config.ssl.client.verify.server", OV_Pair{TS_CONFIG_SSL_CLIENT_VERIFY_SERVER, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.cluster_cache_local", OV_Pair{TS_CONFIG_HTTP_CACHE_CLUSTER_CACHE_LOCAL, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.ignore_server_no_cache", OV_Pair{TS_CONFIG_HTTP_CACHE_IGNORE_SERVER_NO_CACHE, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.origin_max_connections", OV_Pair{TS_CONFIG_HTTP_ORIGIN_MAX_CONNECTIONS, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.fuzz.time", OV_Pair{TS_CONFIG_HTTP_CACHE_FUZZ_TIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.fuzz.min_time", OV_Pair{TS_CONFIG_HTTP_CACHE_FUZZ_MIN_TIME, TS_RECORDDATATYPE_INT}},
   {"proxy.config.http.cache.fuzz.probability", OV_Pair{TS_CONFIG_HTTP_CACHE_FUZZ_PROBABILITY, TS_RECORDDATATYPE_FLOAT}},
