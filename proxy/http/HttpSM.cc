...
HttpSM::state_read_client_request_header(int event, void *data)
{
...
#ifdef PROXY_DRAIN
  int HttpSM::state_drain_client_request_body(int event, void *data)
  {
  ...
  int HttpSM::state_watch_for_client_abort(int event, void *data)
  {
  ...
  void HttpSM::setup_push_read_response_header()
  {
    ink_assert(server_session == NULL);
    ink_assert(server_entry == NULL);
  ...
  int HttpSM::state_read_push_response_header(int event, void *data)
  {
  ...
  //
  //////////////////////////////////////////////////////////////////////////////
  int HttpSM::state_raw_http_server_open(int event, void *data)
  {
  ...
  //
  int HttpSM::state_common_wait_for_transform_read(HttpTransformInfo * t_info, HttpSMHandler tunnel_handler, int event, void *data)
  {
  ...
  int HttpSM::state_api_callout(int event, void *data)
  {
    ...
    case HTTP_API_CONTINUE:
      if ((cur_hook_id >= 0) && (cur_hook_id < TS_HTTP_LAST_HOOK)) {
        ...
        if (cur_hook) {
          ...
          DebugSM("http", "[%" PRId64 "] calling plugin on hook %s at hook %p", sm_id,
  ...
  //
  //////////////////////////////////////////////////////////////////////////////
  int HttpSM::state_http_server_open(int event, void *data)
  {
  ...
  int HttpSM::state_read_server_response_header(int event, void *data)
  {
  ...
  int HttpSM::state_send_server_request_header(int event, void *data)
  {
  ...
  //
  //////////////////////////////////////////////////////////////////////////////
  int HttpSM::state_hostdb_lookup(int event, void *data)
  {
  ...
  int HttpSM::state_hostdb_reverse_lookup(int event, void *data)
  {
  ...
  //
  //////////////////////////////////////////////////////////////////////////////
  int HttpSM::state_mark_os_down(int event, void *data)
  {
  ...
  //
  //////////////////////////////////////////////////////////////////////////
  int HttpSM::state_handle_stat_page(int event, void *data)
  {
  ...
  //
  ///////////////////////////////////////////////////////////////
  int HttpSM::state_icp_lookup(int event, void *data)
  {
  ...
  //
  //////////////////////////////////////////////////////////////////////////
  int HttpSM::state_cache_open_write(int event, void *data)
  {
  ...
  inline void HttpSM::setup_cache_lookup_complete_api()
  {
  ...
  //
  //////////////////////////////////////////////////////////////////////////
  int HttpSM::state_cache_open_read(int event, void *data)
  {
  ...
  //  operation.
  //////////////////////////////////////////////////////////////////////////
  int HttpSM::state_cache_open_partial_read(int event, void *data)
  {
  ...
  int HttpSM::main_handler(int event, void *data)
  {
    ink_release_assert(magic == HTTP_SM_MAGIC_ALIVE);
  ...
  //
  void HttpSM::tunnel_handler_post_or_put(HttpTunnelProducer * p)
  {
  ...
  int HttpSM::tunnel_handler_cache_fill(int event, void *data)
  {
  ...
  int HttpSM::tunnel_handler_100_continue(int event, void *data)
  {
  ...
  int HttpSM::tunnel_handler_push(int event, void *data)
  {
  ...
  int HttpSM::tunnel_handler(int event, void *data)
  {
  ...
  bool HttpSM::is_http_server_eos_truncation(HttpTunnelProducer * p)
  {
  ...
  int HttpSM::tunnel_handler_server(int event, HttpTunnelProducer *p)
  {
  ...
  bool HttpSM::is_bg_fill_necessary(HttpTunnelConsumer * c)
  {
  ...
  int HttpSM::tunnel_handler_ua(int event, HttpTunnelConsumer *c)
  {
  ...
  int HttpSM::tunnel_handler_ua_push(int event, HttpTunnelProducer *p)
  {
  ...
  int HttpSM::tunnel_handler_cache_read(int event, HttpTunnelProducer *p)
  {
  ...
  int HttpSM::tunnel_handler_cache_write(int event, HttpTunnelConsumer *c)
  {
  ...
  int HttpSM::tunnel_handler_post_ua(int event, HttpTunnelProducer *p)
  {
  ...
  int HttpSM::tunnel_handler_for_partial_post(int event, void * /* data ATS_UNUSED */)
  {
  ...
  int HttpSM::tunnel_handler_post_server(int event, HttpTunnelConsumer *c)
  {
  ...
  int HttpSM::tunnel_handler_ssl_producer(int event, HttpTunnelProducer *p)
  {
  ...
  int HttpSM::tunnel_handler_ssl_consumer(int event, HttpTunnelConsumer *c)
  {
  ...
  int HttpSM::tunnel_handler_transform_write(int event, HttpTunnelConsumer *c)
  {
  ...
  int HttpSM::tunnel_handler_transform_read(int event, HttpTunnelProducer *p)
  {
  ...
  int HttpSM::tunnel_handler_plugin_agent(int event, HttpTunnelConsumer *c)
  {
  ...
  int HttpSM::state_srv_lookup(int event, void *data)
  {
  ...
  int HttpSM::state_remap_request(int event, void * /* data ATS_UNUSED */)
  {
  ...
  void HttpSM::do_remap_request(bool run_inline)
  {
  ...
  void HttpSM::do_hostdb_reverse_lookup()
  {
    ink_assert(t_state.dns_info.lookup_name != NULL);
    ink_assert(pending_action == NULL);
  ...
  void HttpSM::do_hostdb_update_if_necessary()
  {
    ...
    if (issue_update) {
      hostDBProcessor.setby(t_state.current.server->name, strlen(t_state.current.server->name),
                            &t_state.current.server->dst_addr.sa, &t_state.host_db_info.app);
    }
   ...
   */
  void HttpSM::parse_range_and_compare(MIMEField * field, int64_t content_length)
  {
    (void)field;
    (void)content_length;
    return;
...
Lfaild:
  ...
  void HttpSM::calculate_output_cl(int64_t content_length, int64_t num_chars)
  {
#if 1
    (void)content_length;
    (void)num_chars;
  ...
  void HttpSM::do_cache_lookup_and_read()
  {
    // TODO decide whether to uncomment after finish testing redirect
    // ink_assert(server_session == NULL);
  ...
  void HttpSM::do_cache_delete_all_alts(Continuation * cont)
  {
  ...
  inline void HttpSM::do_cache_prepare_write()
  {
  ...
  inline void HttpSM::do_cache_prepare_write_transform()
  {
  ...
  void HttpSM::do_cache_prepare_update()
  {
  ...
  void HttpSM::do_cache_prepare_action(HttpCacheSM * c_sm, CacheHTTPInfo * object_read_info, bool retry, bool allow_multiple)
  {
  ...
  //
  //////////////////////////////////////////////////////////////////////////
  void HttpSM::do_http_server_open(bool raw)
  {
  ...
  void HttpSM::do_api_callout_internal()
  {
  ...
  void HttpSM::mark_host_failure(HostDBInfo * info, time_t time_down)
  {
    char addrbuf[INET6_ADDRPORTSTRLEN];
  ...
  void HttpSM::set_ua_abort(HttpTransact::AbortState_t ua_abort, int event)
  {
  ...
  void HttpSM::mark_server_down_on_client_abort()
  {
    /////////////////////////////////////////////////////
  ...
  //
  void HttpSM::release_server_session(bool serve_from_cache)
  {
    if (server_session == NULL) {
      return;
    }
  ...
  void HttpSM::setup_transform_to_server_transfer()
  {
    ink_assert(post_transform_info.vc != NULL);
...
#ifdef PROXY_DRAIN
  void HttpSM::do_drain_request_body()
  {
  ...
  void HttpSM::do_setup_post_tunnel(HttpVC_t to_vc_type)
  {
    ...
    if (t_state.redirect_info.redirect_in_process && enable_redirection &&
      ...
      p = tunnel.add_producer(ua_entry->vc, post_bytes - transfered_bytes, buf_start, &HttpSM::tunnel_handler_post_ua,
  ...
  void HttpSM::issue_cache_update()
  {
    ink_assert(cache_sm.cache_write_vc != NULL);
    if (cache_sm.cache_write_vc) {
  ...
  int HttpSM::write_header_into_buffer(HTTPHdr * h, MIOBuffer * b)
  {
    int bufindex;
    int dumpoffset;
    int done, tmp;
  ...
  void HttpSM::setup_server_send_request_api()
  {
    t_state.api_next_action = HttpTransact::SM_ACTION_API_SEND_REQUEST_HDR;
    do_api_callout();
  }

  void HttpSM::setup_server_send_request()
  {
    int hdr_length;
    ...
    if (t_state.api_server_request_body_set) {
      DebugSM("http", "[%" PRId64 "] appending msg of %" PRId64 " bytes to request %s", sm_id, msg_len,
  ...
  void HttpSM::setup_server_read_response_header()
  {
    ink_assert(server_session != NULL);
    ink_assert(server_entry != NULL);
  ...
  HttpTunnelProducer *HttpSM::setup_cache_read_transfer()
  {
  ...
  HttpTunnelProducer *HttpSM::setup_cache_transfer_to_transform()
  {
    int64_t alloc_index;
    int64_t doc_size;
  ...
  void HttpSM::setup_cache_write_transfer(HttpCacheSM * c_sm, VConnection * source_vc, HTTPInfo * store_info, int64_t skip_bytes,
                                          const char *name)
  {
  ...
  void HttpSM::setup_100_continue_transfer()
  {
  ...
  //
  //////////////////////////////////////////////////////////////////////////
  void HttpSM::setup_error_transfer()
  {
  ...
  void HttpSM::setup_internal_transfer(HttpSMHandler handler_arg)
  {
  ...
  //
  int HttpSM::find_http_resp_buffer_size(int64_t content_length)
  {
    int64_t buf_size;
    int64_t alloc_index;
  ...
  //      tunnel
  //
  int64_t HttpSM::server_transfer_init(MIOBuffer * buf, int hdr_size)
  {
    int64_t nbytes;
  ...
  HttpTunnelProducer *HttpSM::setup_server_transfer_to_transform()
  {
    int64_t alloc_index;
    int64_t nbytes;
  ...
  HttpTunnelProducer *HttpSM::setup_transfer_from_transform()
  {
  ...
  HttpTunnelProducer *HttpSM::setup_transfer_from_transform_to_cache_only()
  {
    int64_t alloc_index = find_server_buffer_size();
    MIOBuffer *buf = new_MIOBuffer(alloc_index);
    IOBufferReader *buf_start = buf->alloc_reader();
  ...
  HttpTunnelProducer *HttpSM::setup_server_transfer_to_cache_only()
  {
  ...
  HttpTunnelProducer *HttpSM::setup_server_transfer()
  {
  ...
  HttpTunnelProducer *HttpSM::setup_push_transfer_to_cache()
  {
  ...
  void HttpSM::setup_blind_tunnel(bool send_response_hdr)
  {
    ...
    p_ua =
      tunnel.add_producer(ua_entry->vc, -1, r_from, &HttpSM::tunnel_handler_ssl_producer, HT_HTTP_CLIENT, "user agent - tunnel");
  ...
  void HttpSM::setup_plugin_agents(HttpTunnelProducer * p)
  {
  ...
  inline void HttpSM::transform_cleanup(TSHttpHookID hook, HttpTransformInfo * info)
  {
  ...
  void HttpSM::plugin_agents_cleanup()
  {
  ...
  void HttpSM::dump_state_hdr(HTTPHdr * h, const char *s)
  {
  ...
  void HttpSM::call_transact_and_set_next_state(TransactEntryFunc_t f)
  {
  ...
  bool HttpSM::do_congestion_control_lookup()
  {
    ink_assert(pending_action == NULL);
  ...
  int HttpSM::state_congestion_control_lookup(int event, void *data)
  {
  ...
  void HttpSM::redirect_request(const char *redirect_url, const int redirect_len)
  {
  ...
  int HttpSM::get_http_schedule(int event, void * /* data ATS_UNUSED */)
  {
    bool plugin_lock;
    Ptr<ProxyMutex> plugin_mutex;
  ...
  inline bool HttpSM::is_redirect_required()
  {
  ...
  char const *HttpSM::handlerName(int (HttpSM::*ptm)(int, void *))
  {
