...
static const RecordElement RecordsConfig[] =
{
  ...
  ,
  {RECT_CONFIG, "proxy.config.http.chunking.accept_truncated_content", RECD_INT, "0", RECU_DYNAMIC, RR_NULL, RECC_NULL, nullptr, RECA_NULL}
  ,
  ...
  ,
  {RECT_CONFIG, "proxy.config.http2.max_ping_per_minute", RECD_INT, "60", RECU_DYNAMIC, RR_NULL, RECC_STR, "^[0-9]+$", RECA_NULL}
  ,
