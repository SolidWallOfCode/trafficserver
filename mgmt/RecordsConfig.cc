...
static const RecordElement RecordsConfig[] =
{
  ...
  ,
  {RECT_CONFIG, "proxy.config.plugin.priority.default", RECD_INT, "1000", RECU_DYNAMIC, RR_NULL, RECC_INT, NULL, RECA_NULL },
  {RECT_CONFIG, "proxy.config.plugin.priority.effective_gap", RECD_INT, "200", RECU_DYNAMIC, RR_NULL, RECC_INT, NULL, RECA_NULL },
