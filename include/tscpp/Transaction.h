...
#include <list>
#include <memory>
#include "tscpp/Request.h"
#include "tscpp/ClientRequest.h"
#include "tscpp/Response.h"
#include "tscpp/HttpStatus.h"
...
public:
  /**
   * @brief ContextValues are a mechanism to share data between plugins using the tscpp.
   *
   ...
   * @see tscpp::utils::getIpString() in tscpp/utils.h
   * @see tscpp::utils::getPort() in tscpp/utils.h
   * @see tscpp::utils::getIpPortString in tscpp/utils.h
   */
   ...
   * An example would be using TSFetchUrl (or the tscpp equivalent of AsyncHttpFetch)
