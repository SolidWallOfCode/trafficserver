...
#include <string>
#include <tscpp/noncopyable.h>

#if !defined(tscpp_PRINTFLIKE)
 ...
 * @private
 */
#define tscpp_PRINTFLIKE(fmt, arg) __attribute__((format(printf, fmt, arg)))
#else
#define tscpp_PRINTFLIKE(fmt, arg)
#endif
#endif
 ...
 * @private
 */
extern "C" void TSDebug(const char *tag, const char *fmt, ...) tscpp_PRINTFLIKE(2, 3);
 ...
 * @private
 */
extern "C" void TSError(const char *fmt, ...) tscpp_PRINTFLIKE(1, 2);
...
public:
   ...
   * \endcode
   */
  void logDebug(const char *fmt, ...) tscpp_PRINTFLIKE(2, 3);
   ...
   */
  void logInfo(const char *fmt, ...) tscpp_PRINTFLIKE(2, 3);
   ...
   */
  void logError(const char *fmt, ...) tscpp_PRINTFLIKE(2, 3);
